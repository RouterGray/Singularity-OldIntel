...
extern AIHTTPTimeoutPolicy keyVerificationReceiver_timeout;
...
public :
	 ...
	 */
	class KeyVerificationReceiver: public LLHTTPClient::ResponderWithResult
	{
	public:
		virtual AIHTTPTimeoutPolicy const& getHTTPTimeoutPolicy(void) const { return keyVerificationReceiver_timeout; }
